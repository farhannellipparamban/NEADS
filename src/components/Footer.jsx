  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        ...
        >
          <motion.div variants={fadeIn} className="footer-brand">
            <Link to="/" className="footer-logo">
              <img src={logo} alt="NEADS Logo" className="footer-logo-img" />
            </Link>
          ...
          <motion.div variants={fadeIn} className="footer-contact">
            ...
            <address className="footer-address">
              <p>
                First floor PAG Tower Chinakkal Sirhind Nagar, Cherushola
                (Po),Chenakkal, Kottakkal, Malappuram Kerala 676510
              </p>
              <p></p>
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} NeadsIndia. All rights reserved.
            Developed by Neuraq Technologies
          </p>
        </motion.div>
      </div>
    </footer>
